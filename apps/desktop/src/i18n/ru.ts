...
export const ru = defineLocale({
  ...
  settings: {
    ...
    notifications: {
      ...
      completionSoundDesc: 'Воспроизводится, когда ход агента завершён. Выберите пресет и прослушайте здесь. У подтверждений, вопросов, ошибок и завершённых фоновых задач свой короткий сигнал, с тем же отключением звука.',
