...
/** Why a known Sbar Rafiq command has no desktop UI surface. */
...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/profile', description: 'Switch the active Sbar Rafiq profile', surface: action('profile') },
  {
    name: '/skin',
 ...
 * Sbar Rafiq' built-in slash commands — i.e. skill commands (`/gif-search`,
 ...
 * activity — the ones that ship with Sbar Rafiq and were never asked for. It is
