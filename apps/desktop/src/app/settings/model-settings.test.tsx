...
describe('ModelSettings', () => {
  ...
  it.each(['zh', 'zh-hant'] as const)(
    ...
    async locale => {
      ...
      const { TRANSLATIONS } = await import('@/i18n/all-translations')
      const { loadTranslations } = await import('@/i18n')
      // Non-English catalogs load on demand; fetch this one before rendering.
