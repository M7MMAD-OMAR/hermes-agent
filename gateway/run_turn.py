...
class GatewayTurnMixin:
    ...
    def _run_agent_timeout_result(self, worker, turn_ctx: TurnContext) -> dict:
        ...
        from agent.interrupt_origin import TURN_TIMEOUT
        from gateway.run import (_INTERRUPT_REASON_TIMEOUT, _INTERRUPT_TOOL_REASON_TIMEOUT,
        ...
        if _timed_out_agent:
            request_hard_interrupt(_timed_out_agent, _INTERRUPT_REASON_TIMEOUT,
                                   tool_reason=_INTERRUPT_TOOL_REASON_TIMEOUT, origin=TURN_TIMEOUT)
