...
export function displayName(bot: Partial<RosterRow>, meta?: BotMeta | null): string {
  ...
  // "Sbar Rafiq". Annotated active rows carry sourceScoped too, and keying this
  ...
  // never generic "Sbar Rafiq" or a hostname-derived label.
  if (alias) {
  ...
  // that reads like nobody bothered. Present it as Sbar Rafiq (the agent it is)
