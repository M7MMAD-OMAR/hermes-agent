...
|------|--------------|--------------|
| `paragraph` | `.paragraph.rich_text` | none |
| `heading_1/2/3` | `.heading_N.rich_text` | none |
| `bulleted_list_item` | `.bulleted_list_item.rich_text` | none |
| `numbered_list_item` | `.numbered_list_item.rich_text` | none |
| `to_do` | `.to_do.rich_text` | `.to_do.checked` (bool) |
| `toggle` | `.toggle.rich_text` | has children |
| `code` | `.code.rich_text` | `.code.language` |
| `quote` | `.quote.rich_text` | none |
