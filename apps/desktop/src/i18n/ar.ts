...
export const ar = defineLocale({
  ...
  boot: {
    ready: 'Sbar Rafiq Desktop جاهز',
    desktopBootFailedWithMessage: message => `فشل تشغيل سطح المكتب: ${message}`,
    steps: {
      connectingGateway: 'جار الاتصال ببوابة سطح المكتب',
      loadingSettings: 'جار تحميل إعدادات Sbar Rafiq',
      loadingSessions: 'جار تحميل الجلسات الأخيرة',
      retryingRemoteBackend: 'جارٍ إعادة الاتصال بخادم Sbar Rafiq البعيد…',
      startingDesktopConnection: 'جار بدء اتصال سطح المكتب',
      startingHermesDesktop: 'جار تشغيل Sbar Rafiq Desktop...'
    },
    errors: {
      backgroundExited: 'خرجت عملية Sbar Rafiq الخلفية.',
      backgroundExitedDuringStartup: 'خرجت عملية Sbar Rafiq الخلفية أثناء بدء التشغيل.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage: 'خلفية Sbar Rafiq أقدم من إصدار سطح المكتب الحالي وقد لا تعمل كما يجب. حدثهما ليتوافقا.',
    updateHermes: 'تحديث Sbar Rafiq',
  ...
  settings: {
    ...
    gateway: {
      ...
      sshConnect: 'اتصال',
      sshDesc:
        'يُشغَّل Sbar Rafiq على الجهاز البعيد عبر SSH ويُنفَّق إلى هذا التطبيق، فلا شيء تحتاج إلى تشغيله أو تعريضه بنفسك. يتطلب ذلك وصول SSH عاملا بالمفاتيح إلى المضيف.',
      sshErrAuth:
        'فشلت مصادقة SSH. حمّل مفتاحك في ssh-agent (ssh-add) أو اضبط IdentityFile في ~/.ssh/config، فـ Sbar Rafiq يشغّل ssh دون تفاعل.',
      sshErrHostKey:
        'تغيّر مفتاح المضيف منذ آخر اتصال لك. تحقق من أن هذا متوقع، ثم شغّل ssh-keygen -R <host> وأعد الاتصال.',
      sshErrNotInstalled:
        'Sbar Rafiq غير مثبت على المضيف البعيد. ثبّته هناك (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) أو اضبط مسار Sbar Rafiq.',
      sshErrPlatform:
        'منصة بعيدة غير مدعومة. يدعم نمط SSH في Sbar Rafiq Desktop المضيفات البعيدة على Linux وmacOS وWindows.',
      ...
      sshErrUpdateRequired: 'حدّث Sbar Rafiq على المضيف البعيد قبل الاتصال عبر SSH في سطح المكتب.',
      ...
      sshHermesPathTitle: 'مسار Sbar Rafiq (اختياري)',
    ...
    uninstallSection: {
      ...
      uninstallHermes: 'إلغاء تثبيت Sbar Rafiq',
  ...
  threads: {
    ...
    title: 'المسارات',
    subtitle: 'عمل تابع بعد انتهاء الدور.',
    emptyTitle: 'لا توجد مسارات بعد',
    emptyDesc: 'عندما تفوّض هذه المحادثة عملاً في الخلفية، يظهر كل مسار هنا بنصه الخاص.',
    working: 'قيد العمل',
    workingDesc: 'يعمل الآن.',
    resolved: 'منتهية',
    resolvedDesc: 'المسارات المكتملة تُحفظ هنا.',
    failed: 'متعثرة',
    failedDesc: 'توقفت قبل أن تكتمل.',
    waiting: 'بانتظارك',
    waitingDesc: 'قرارات ومراجعات وأذونات لا يعطيها غيرك.',
    live: 'حي',
    ...
    model: 'النموذج',
    started: 'البداية',
    openThread: 'فتح المسار',
    backToThreads: 'العودة إلى المسارات',
    transcript: 'النص',
    transcriptTail: 'تُعرض أحدث الرسائل.',
    transcriptEmpty: 'لم يكتب هذا المسار شيئاً بعد.',
    transcriptFailed: 'تعذّرت قراءة هذا المسار.',
    steerPlaceholder: 'وجّه هذا المسار...',
    steerSend: 'أرسل إلى المسار',
    steerSent: 'أُرسلت إلى المسار.',
    steerFailed: 'تعذّر الوصول إلى هذا المسار.',
    steerUnavailable: 'انتهى هذا المسار، فلا شيء لتوجيهه.',
    routedTo: 'أُرسلت إلى المسار',
    routeUndo: 'تراجع',
    refresh: 'تحديث المسارات',
    loading: 'تجري قراءة المسارات...'
  },
  agents: {
