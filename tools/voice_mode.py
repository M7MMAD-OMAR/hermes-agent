...
def _import_audio():
    ...
    import numpy as np
    # The wake-word probe releases PortAudio when nothing is armed; a voice turn must
    # bring it back before it opens a stream. One helper owns that private-API poke.
    from tools.wake_word import _ensure_portaudio
