...
function StaleAuxWarning({ applying, onReset, slots, taskLabel }: StaleAuxWarningProps) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 rounded-md bg-(--ui-warning-background) px-3 py-2 text-xs text-(--ui-warning)">
          ...
          {needsSetup && !setupIsApiKey && selectedProviderRow && (
            <p className="mt-2 text-xs text-muted-foreground">
              {selectedProviderRow?.auth_type === 'api_key'
                ...
                : `${selectedProviderRow?.name} signs in through your browser — Sbar Rafiq runs the flow for you.`}
            </p>
          )}
