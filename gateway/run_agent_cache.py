...
class GatewayAgentCacheMixin:
    ...
    def _interrupt_running_turn(
        self, session_key: str, *, interrupt_reason: str, invalidation_reason: str,
        ...
        if running_agent and running_agent is not _AGENT_PENDING_SENTINEL:
            ...
            with _log_suppressed(logging.WARNING, "Failed to interrupt running agent for %s; continuing",
                ...
                request_hard_interrupt(
                    running_agent, interrupt_reason, tool_reason=tool_reason,
                    # Through the class: test doubles and bare runners stand in for `self`.
                    origin=GatewayAgentCacheMixin._origin_for_invalidation(invalidation_reason),
                )
