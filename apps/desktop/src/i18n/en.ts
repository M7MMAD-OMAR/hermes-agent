...
export const en: Translations = {
  ...
  connectorsPage: {
    ...
    card: {
      ...
      inCatalog: 'In the Sbar Rafiq catalog',
    ...
    page: {
      ...
      noMatchBody: 'Nothing here matches. Point Sbar Rafiq at your own MCP server to add it.',
      ...
      disconnectNoAccount: 'Sbar Rafiq has no account to disconnect here. Refresh the page and try again.',
      disconnectRefused:
    ...
    dialog: {
      ...
      disconnectBody: 'Sbar Rafiq stops acting as this account. You can connect again at any time.',
      ...
      appSwitch: (name: string) => `Sbar Rafiq can use ${name}`,
      waysTitle: (name: string) => `Where ${name} runs`,
      wayNotConnected: (name: string) => `Not connected yet. Sign in to ${name} in your browser.`,
      wayHosted: 'Managed',
      bothOn: (name: string) => `Both are on, so Sbar Rafiq sees every ${name} tool twice.`,
      ...
      rulesSignIn: 'Sign in to change what Sbar Rafiq may do here.',
    ...
    tools: {
      ...
      summaryTitle: (name: string) => `What Sbar Rafiq may do with ${name}`,
      summaryPreviewTitle: (name: string) => `What Sbar Rafiq could do with ${name} once you connect`,
      ...
      goneBody: 'Sbar Rafiq cannot call it any more. The row stays until you remove it, so nothing vanishes.',
      remove: 'Remove',
  ...
  keybinds: {
    ...
    actions: {
      ...
      'view.toggleAnnotate': 'Toggle page commenting',
  ...
  settings: {
    ...
    gateway: {
      ...
      unavailableDesc:
        'Connection settings can only be changed from the Sbar Rafiq Desktop app on the computer running it.',
      ...
      probeError:
        "Sbar Rafiq can't reach that address. Check the URL and that the other computer is running Sbar Rafiq — sign-in options appear once it answers.",
      signedIn: 'Signed in',
      signIn: 'Sign in',
      signOut: 'Sign out',
  ...
  artifacts: {
    ...
    skippedMessages: count => `${count} oversized messages were skipped. Their results may be missing.`,
    versions: 'Saved versions',
    captureVersion: 'Save current file as a version',
    captureHint:
      'Saves the file as it exists now, up to 25 MiB. Each saved version keeps its own review status, even if the original changes or is deleted.',
    ...
    openVersion: 'Open saved file',
    search: 'Search artifacts...',
    refresh: 'Refresh artifacts',
    refreshing: 'Refreshing artifacts',
    indexing: 'Indexing conversation results',
    tabAll: 'All',
    tabImages: 'Images',
    tabFiles: 'Files',
    tabLinks: 'Links',
  ...
  sidebar: {
    ...
    projects: {
      ...
      transferWorking: sessions => `Carrying ${sessions} conversation${sessions === 1 ? '' : 's'}\u2026`,
  ...
  updates: {
    ...
    gitUnusable: 'Sbar Rafiq could not run Git on this computer, so it could not check for updates.',
    connectionSettings: 'Connection settings',
  ...
  freeTier: {
    ...
    setupFailed: {
      ...
      generic:
        "Sbar Rafiq couldn't set up free access without signing in. Signing in is free, or connect another provider.",
  ...
  preview: {
    ...
    viewport: {
      fit: 'Fit',
      fitTitle: 'Fill the pane, as before',
    ...
    pins: {
      ...
      noLivePage: 'no live page',
      armedHint: 'click an element, or drag a region · Esc to stop',
      openCount: count => `${count} open`,
      elsewhere: (count, pages) => `· ${count} on ${pages} other page${pages === 1 ? '' : 's'}`,
      sendAll: 'Send all',
      sendAllTitle: 'Add every pending comment, across every page, to the chat',
      clear: 'Clear',
      clearTitle: 'Discard the whole review, every page',
      region: 'region',
      imageCount: count => `·${count} images`,
      detached: '· detached',
      noComment: 'no comment yet',
      sendNow: 'Send this comment to the chat now',
      queue: "Add this comment to the conversation's queue",
      reopen: 'Reopen',
      ...
      sentTitle: 'Sent',
      sentMessage: 'Comment sent to the chat.',
      sendFailedTitle: 'Could not send',
      sendFailedMessage: 'No conversation is open to receive it.',
      queuedTitle: 'Queued',
      queuedMessage: 'Comment parked in the queue.',
      queueFailedTitle: 'Could not queue',
      queueFailedMessage: 'No conversation is open to queue it in.',
      addedTitle: 'Added to chat',
      addedMessage: count => `${count} comment${count === 1 ? '' : 's'} ready in the composer`,
      addFailedTitle: 'Could not add to chat',
      addFailedMessage: 'No composer window is open to receive them.'
    }
  },
  ...
  assistant: {
    thread: {
      ...
      turnDigestNotes: count => `${count} ${count === 1 ? 'note' : 'notes'}`,
      turnOutcomeDelivered: 'Delivered',
      turnOutcomeFailed: 'Failed',
      turnOutcomeOpen: 'Open',
      turnOutcomeTitle: 'Turn outcome',
      progressTitle: 'Task progress',
      progressTask: 'Working on',
      progressEdit: 'Last recorded edit',
      progressCheck: 'Last successful check',
      progressCheckOutdated: 'Check predates latest edit',
      progressError: 'Latest reported error',
      progressRepeated: 'Repeated action',
      ...
      errorLayerBodies: {
        ...
        endpoint:
          "Sbar Rafiq can't reach your custom model server. Check that it is running, then send your message again.",
        gateway:
          'Sbar Rafiq hit an internal problem starting this reply. Send your message again; if it keeps happening, send diagnostics.',
  ...
  desktop: {
    ...
    handoff: {
      ...
      timedOut:
        "Sbar Rafiq couldn't reach your messaging connection. Start it from Settings → Messaging, then try the handoff again.",
