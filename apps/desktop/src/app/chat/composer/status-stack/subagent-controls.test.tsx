...
it('spectates the child conversation, and only when the worker reported its own session', () => {
  ...
  // `watch` is what keeps this a live mirror rather than adopting a session the
  // parent is still driving, so it is part of the contract, not a detail.
