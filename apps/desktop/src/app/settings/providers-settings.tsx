...
function ConnectedProviderRow({
  ...
  // Sbar Rafiq can clear this provider's creds via the API.
  const canDisconnect = provider.disconnectable ?? provider.flow !== 'external'
  // External (CLI-managed) provider Sbar Rafiq can't clear via the API, but ships a
...
export function ProvidersSettings({
  ...
  // Sbar Rafiq never deletes creds another tool owns behind a silent API call.
