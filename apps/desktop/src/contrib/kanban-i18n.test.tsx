...
// Non-English catalogs load on demand; fetch the ones this test switches to.
beforeAll(async () => {
  await Promise.all([loadTranslations('zh'), loadTranslations('ja'), loadTranslations('zh-hant')])
})
