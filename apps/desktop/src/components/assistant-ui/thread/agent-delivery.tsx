      ...
      {!pending && replyBody && (
        <div className={NOTICE_CLASS} data-slot="aui_agent-reply-notice">
          ...
          <details className="self-center">
            ...
            <div className="mt-1 max-w-[36rem] whitespace-pre-wrap rounded-lg border border-(--ui-stroke-tertiary) px-3 py-2 text-start text-[0.75rem] leading-5 text-foreground/85">
              {replyBody}
            </div>
          </details>
        </div>
