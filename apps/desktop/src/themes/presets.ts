...
/**
 * Nous — the canonical Sbar Rafiq desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays Sbar Rafiq's own: a VS Code theme carries no font opinion, and
...
/**
 * Nous — the canonical Sbar Rafiq desktop identity: GitHub's chrome carrying Nous
