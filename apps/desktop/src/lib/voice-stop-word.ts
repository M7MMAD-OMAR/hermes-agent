...
//
// When someone is in a hands-free "Hey Sbar Rafiq" voice chat, the natural way to
...
// phrase (optionally addressed to Sbar Rafiq), so a real turn that merely contains
 ...
 * to Sbar Rafiq). Returns false for anything that merely contains "stop" as part of
