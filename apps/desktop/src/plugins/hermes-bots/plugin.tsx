/**
 * Sbar Rafiq Bot Mode — a "one chat per agent" roster for the Sbar Rafiq desktop.
 *
 * Left pane "Bots": one row per Sbar Rafiq profile (a bot = an agent profile) with
 ...
 *
 * Right tile "Routines": scheduled tasks (Sbar Rafiq cron jobs) scoped to the
...
export default {
  ...
  register(ctx: PluginContext) {
    ...
    // A bot's chat before it has spoken: core's splash is Sbar Rafiq' wordmark and
