...
describe('the Bots pane dock', () => {
  it('renders its tab label from the live locale, not the register-time string', async () => {
    paneStores()

    // Non-English catalogs load on demand; a static render only sees one that
    ...
    try {
      ...
      // A leaked registration keeps listening to shared stores and skews every
