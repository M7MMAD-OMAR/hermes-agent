...
export function TerminalRail() {
  ...
  return (
    <div
      className="group/rail relative z-40 flex h-full w-9 shrink-0 flex-col items-center border-s border-(--ui-stroke-quaternary) bg-(--ui-terminal-surface-background)"
      ...
      <ContextMenuTrigger asChild>
        <li className="relative flex w-full justify-center [-webkit-app-region:no-drag]">
          {active && (
            <span
              aria-hidden="true"
              className="absolute inset-y-0.5 end-0 w-0.5 rounded-s-sm bg-(--ui-stroke-primary)"
            />
          )}
