...
import { HIDDEN_STREAM_FLUSH_MS } from './utils'
...
// jsdom never presents a frame, so the delta queue runs at the hidden-window
// floor; advancing past it is what lets a queued delta reach the transcript.
const flush = () =>
  act(async () => {
    await vi.advanceTimersByTimeAsync(HIDDEN_STREAM_FLUSH_MS)
  })
