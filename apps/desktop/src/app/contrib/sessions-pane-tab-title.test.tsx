...
import { I18nProvider, loadTranslations, setRuntimeI18nLocale } from '@/i18n'

// Russian loads on demand, and a static render cannot wait for the chunk, so
// fetch it up front. Until it lands the provider (correctly) renders English.
